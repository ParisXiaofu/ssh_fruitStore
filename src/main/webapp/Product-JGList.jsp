...
<div class="Bread_crumbs">
 <div class="Inside_pages clearfix">
   <div class="left">当前位置：<a href="#">首页</a>&gt;<a href="#">坚果馆</a></div>
...
<div class="margintop">
 <DIV class="left_style">
   <div class="title_img_p">
    <strong style="font-family: 楷体;font-size: 34px;position: relative;left: 58px;top: 50px;color: whitesmoke">坚果馆</strong></div>
   <div class="ranking">
 ...
 <DIV class="right_style">
     <div align="center" class="pages_Collects clearfix">
         <a href="/nutsIndex.action?pageIndexs3=1">首页</a>
         <a href="/nutsIndex.action?pageIndexs3=${pageIndexs3-1}">上一页</a>
         <strong ><u>${pageIndexs3}/${totalPages3}</u></strong>
         <a href="/nutsIndex.action?pageIndexs3=${pageIndexs3+1}">下一页</a>
         <a href="/nutsIndex.action?pageIndexs3=${totalPages3}">尾页</a>
     </div>
    <ul class="list_style" >
     <c:forEach var="goods" items="${sessionScope.goodsList3}">
         <li class="clearfix">
             <div class="product_lists clearfix">
                 <a href="addCollection2.action?goodsId=${goods.goodsId}" class="Collect"></a>
                 <a href="#"><img src="images/Nuts/${goods.goodsPic}"  width='207' height='219'/></a>
                 ...
                 <p class="btn_style"><a href="goodsDetail.action?goodsId=${goods.goodsId}" class="buy_btn"></a><a href="addCar3.action?goodsId=${goods.goodsId}&goodsPrice=${goods.goodsPrice}" class="Join_btn"></a></p>
             </div>
         </li>
     </c:forEach>
    </ul>
