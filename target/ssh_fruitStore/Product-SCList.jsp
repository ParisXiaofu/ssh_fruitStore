...
<div class="Bread_crumbs">
 <div class="Inside_pages clearfix">
   <div class="left">当前位置：<a href="#">首页</a>&gt;<a href="#">蔬菜馆</a></div>
...
<div class="margintop">
 <DIV class="left_style">
   <div class="title_img_p"><strong style="font-family: 楷体;font-size: 34px;position: relative;left: 58px;top: 50px;color: whitesmoke">蔬菜馆</strong></div>
   <div class="ranking">
 ...
 <DIV class="right_style">
     <div align="center" class="pages_Collects clearfix">
         <a href="/vegetablesIndex.action?pageIndexs2=1">首页</a>
         <a href="/vegetablesIndex.action?pageIndexs2=${pageIndexs2-1}">上一页</a>
         <strong ><u>${pageIndexs2}/${totalPages2}</u></strong>
         <a href="/vegetablesIndex.action?pageIndexs2=${pageIndexs2+1}">下一页</a>
         <a href="/vegetablesIndex.action?pageIndexs2=${totalPages2}">尾页</a>
     </div>
    <ul class="list_style" >
     <c:forEach var="goods" items="${sessionScope.goodsList2}">
         <li class="clearfix">
             <div class="product_lists clearfix">
                 <a href="addCollection3.action?goodsId=${goods.goodsId}" class="Collect"></a>
                 <a href="#"><img src="images/vegtables/${goods.goodsPic}"  width='207' height='219'/></a>
                 ...
                 <p class="btn_style"><a href="goodsDetail.action?goodsId=${goods.goodsId}" class="buy_btn"></a><a href="addCar4.action?goodsId=${goods.goodsId}&goodsPrice=${goods.goodsPrice}" class="Join_btn"></a></p>
             </div>
         </li>
     </c:forEach>
    </ul>
